...
//@Controller
//@RequestMapping("/")
//public class BlackJackController_old {
//	private Deck deck;
...
//		
//		
//		gamePlay = new GamePlay(player, dealer, playerHand, dealerHand);
//		ArrayList<Hand> hands = gamePlay.startNewRound(betAmount, deck);
//		playerHand = hands.get(0);
//		dealerHand = hands.get(1);
